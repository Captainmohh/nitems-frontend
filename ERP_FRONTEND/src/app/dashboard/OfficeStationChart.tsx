...
const stationData = [
    { station: "SS", count: 280, color: "#2563EB" }, // Blue
    { station: "SW", count: 420, color: "#F59E0B" }, // Amber
    { station: "SE", count: 180, color: "#10B981" }, // Green
    { station: "NW", count: 430, color: "#EA580C" }, // Orange
    { station: "NE", count: 180, color: "#7C3AED" }, // Purple
    { station: "HQ", count: 480, color: "#0F172A" }, // Dark Slate
];
...
export default function OfficeStationChart() {
    return (
